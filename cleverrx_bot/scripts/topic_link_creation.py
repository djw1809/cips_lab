...
class TopicLinkCreation():
    ...
    def __init__(self, tweet = 'This is a sample input about health', path_to_nenp = "../data/NE+NP_v8.csv", path_to_clusterfile = "../data/clusters.pkl",
                path_to_notfound_set_topics = "../data/not_found_set-topics.xlsx"):
